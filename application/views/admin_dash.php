...
<body>
	...
	<div class="container">
		<div class="row">
			<p class="label label-success text-center"><?= $this->session->flashdata("success") ?></p>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-8">
				<ul>
					...
					<li class="pull-right"><a href="/users/new"><button class="btn btn-md btn-primary">Add new</button></a></li>
				</ul>
			</div>
			<div class="col-lg-2"></div>
		</div>
	...
	<div class="container-fluid">
		...
		<?php 			foreach($users as $user){?>
						<tr>
							<td><?= $user['id'] ?></td>
							<td><a href="/users/show/<?= $user['id'] ?>"><?= $user['full_name'] ?></td><td><?= $user['email'] ?></td>
